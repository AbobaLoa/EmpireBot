...
MODES: tuple[ModeSpec, ...] = (
    ModeSpec(
        ...
        notes="Единственный живой экранный сценарий. Ближайшая незакрытая цель к основному замку.",
        status="live",
        target_kind="baron",
        default_quota=20,
        priority=10,
    ...
    ModeSpec(
        ...
        notes="Заглушка. Официально Samurai Invasion; «сёгун» относится к очкам Shogun / Daimyo, не к типу лагеря.",
        status="stub",
        target_kind="samurai",
        default_quota=8,
        priority=61,
